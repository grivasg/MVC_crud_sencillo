...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = "/MVC_crud_sencillo/API/usuario/guardar";
        const config = {
            method: 'POST',
            body
        };
...
const buscar = async () => {
    try {
        const url = "/MVC_crud_sencillo/API/usuario/buscar";
        const config = {
            method: 'GET',
        };
...
const modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario);
        const url = "/MVC_crud_sencillo/API/usuario/modificar";
...
const eliminar = async (usuario) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            ...
            const url = "/MVC_crud_sencillo/API/usuario/eliminar"
            const config = {
                method: 'POST',
                body
            }
