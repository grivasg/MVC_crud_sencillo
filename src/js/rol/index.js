...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = "/MVC_crud_sencillo/API/rol/guardar";
        const config = {
            method: 'POST',
            body
        };
...
const buscar = async () => {
    try {
        const url = "/MVC_crud_sencillo/API/rol/buscar";
        const config = {
            method: 'GET',
        };
...
const modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario);
        const url = "/MVC_crud_sencillo/API/rol/modificar";
...
const eliminar = async (rol) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            ...
            const url = "/MVC_crud_sencillo/API/rol/eliminar"
            const config = {
                method: 'POST',
                body
            }
